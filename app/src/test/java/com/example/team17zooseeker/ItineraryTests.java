...
public class ItineraryTests {
    ...
    public void testValidCreationOfItinerary() {
        ...
        String[] cI = {"siamang","hippo","capuchin","owens_aviary","gorilla","entrance_exit_gate"};
    ...
    public void testSkipItinerary(){
        ...
        String[] ciBefore = {"siamang","hippo","capuchin","owens_aviary","gorilla","entrance_exit_gate"};
        ArrayList<String> b_Itinerary = new ArrayList<String>(Arrays.asList(ciBefore));
        assertEquals(b_Itinerary,Itinerary.getItinerary());
        String[] ciAfter = {"hippo","capuchin","owens_aviary","gorilla","entrance_exit_gate"};
